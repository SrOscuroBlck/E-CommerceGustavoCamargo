/**
 * @file AreaCodes.js
 * @description AreaCodes funciona como un archivo que da los codigos de area de configuración para el componente de Login. 
 * (Sinceramente no me funciono un fetch de un archivo json, asi que lo hice asi).
 */
